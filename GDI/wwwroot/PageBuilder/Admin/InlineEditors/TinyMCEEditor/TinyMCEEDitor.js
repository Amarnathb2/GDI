(function () {
    window.kentico.pageBuilder.registerInlineEditor("TinyMCEEditor", {
        init: function (options) {
            ...
            var config = {
                ...
                content_css: '/css/skins/content/default/content.min.css',
        ...
        dragStart: function (options) {
            // Do things here that make dragging the widget look good. 
            // For exaple some wisywigs will not update absolute positioned elements so they will be left from where the widget was originally positioned
            // tinymce doesn't require any updates when the input is repositioned so we are doing nothing.
        }
    });
})();
